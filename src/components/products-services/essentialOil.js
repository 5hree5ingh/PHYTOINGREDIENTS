...
const data = [["1.", "Ajwain Oil", "Trachyspermum ammi", "Peppery and Thyme like Fragrance"],
    ...
    return (
        <div>
            <div className='product-tablename-container'>
                <NavLink to='/essential-oil' className={({ isActive }) => isActive ? 'abc active' : 'abc'}><div className='button'>Essential Oil</div></NavLink>
